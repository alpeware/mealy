...
- [ ] **Pure Intelligence Routing:** Delete `mealy.intelligence.provider` and `mealy.intelligence.router` entirely. Move the provider scoring, budget tracking, and backoff logic into pure functions within a new `mealy.intelligence.core` namespace.
